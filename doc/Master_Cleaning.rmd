...
**Data for Personalized Stat analysis**
```{r}
...
# dataset for tab1: incident count by borough,year,month,incident type
...
save(clean_fire2_stat1, file="../output/clean_fire2_stat1.RData")

# dataset for tab2: incident count by borough,year,month,incident,zipcode
clean_fire2_stat2 <-  group_by(clean_fire2,
                               ZIPCODE,YEAR,MONTH,INCIDENT_CLASSIFICATION_GROUP) %>%
  summarise(c1 = n())
save(clean_fire2_stat2, file="../output/clean_fire2_stat2.RData")

# dataset fort tab3: dataset only with engines and ladders assignment
...
save(clean_fire2_stat3, file="../output/clean_fire2_stat3.RData")

# dataset for tab4: 
clean_fire2_stat4 <- clean_fire2_stat3 %>%
  group_by(INCIDENT_BOROUGH,YEAR,MONTH,INCIDENT_CLASSIFICATION_GROUP,ENGINES) %>%
  summarise(c = n())
save(clean_fire2_stat4, file="../output/clean_fire2_stat4.RData")
